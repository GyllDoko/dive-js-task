...
$(document).ready(function () {
    ...
    function judgement() {
        ...
        // 「Result」(id="alert-indicate) press the button「Your grade is${achievement}It is.${pass_or_failure}It is.」 is the output process.
